...
import { UserIcon, Users, UserPlus, UserMinus, Link, Loader2 } from "lucide-react"; // Import Loader2
...
const RobloxProfileDetails: React.FC<RobloxProfileDetailsProps> = ({ userId }) => {
  ...
  if (!userData) {
    return (
      <div className="flex flex-col items-center justify-center p-6 bg-portfolio-teal rounded-none border-4 border-portfolio-black min-h-[250px]">
        <CardTitle className="text-xl font-bold mb-2 text-always-black">No User Data</CardTitle>
        <CardDescription className="text-center text-always-black">Could not retrieve Roblox user data.</CardDescription>
      </div>
    );
  }
  ...
  return (
    <div className="bg-portfolio-red-pink p-6 rounded-none"> {/* Inner background for details */}
