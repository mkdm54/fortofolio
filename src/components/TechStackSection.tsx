      ...
      <div className="relative w-full overflow-hidden" ref={emblaRef}>
        <div className="flex">
          {techStack.map((tech, index) => (
            ...
            >
              <Badge className="bg-portfolio-red-pink text-white border-2 border-portfolio-black p-4 text-xl font-semibold rounded-md shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] flex flex-col items-center justify-center space-y-2 h-32 w-full">
